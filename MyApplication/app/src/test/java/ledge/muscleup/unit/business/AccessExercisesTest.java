...
public class AccessExercisesTest extends TestCase {
    ...
    @Before
    public void setUp() {
        InterfaceExerciseDataAccess templateDataAccess = new TemplateExerciseDataAccess();

        templateDataAccess.open(null);
        dataAccess = new AccessExercises(templateDataAccess);
    }
     ...
     */
    private class TemplateExerciseDataAccess implements InterfaceExerciseDataAccess {
