...
public class AccessWorkoutSessionsTest extends TestCase {
    ...
    public void setUp()
    {
        dataAccess = new AccessWorkoutSessions(new TemplateWorkoutSessionsAccess());
    }
 ...
 */
class TemplateWorkoutSessionsAccess implements InterfaceWorkoutSessionDataAccess {
